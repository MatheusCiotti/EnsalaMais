...
class _ClassesScreenState extends State<ClassesScreen> {
  ...
  Future<void> _loadData() async {
    try {
      final classesData = await ClassesService.getClasses();
      final professorsData = await ClassesService.getAvailableProfessors();
      final roomsData = await RoomsService.getRooms();

      if (mounted) {
        setState(() {
          classes = classesData;
          _availableProfessors = professorsData;
            ...
            child: Column(
              ...
              children: [
                ...
                DropdownButtonFormField<String>(
                  ...
                  items: _availableProfessors.map((professor) {
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    labelStyle: const TextStyle(color: Colors.white),
                    hintStyle: TextStyle(color: Colors.white.withOpacity(0.5)),
                    hintText: 'Ex: Segunda-feira, 10h às 12h',
                    enabledBorder: OutlineInputBorder(
                      borderRadius: BorderRadius.circular(30),
                      borderSide: BorderSide(color: Colors.white.withOpacity(0.3)),
                    ),
                                ...
                                child: ListTile(
                                  ...
                                  subtitle: Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        'Sala: ${classItem.roomName ?? "Não definida"}',
                                        style: TextStyle(
                                          color: Colors.white.withOpacity(0.7),
                                        ),
                                      ),
                                      if (classItem.observation != null)
                                        Text(
                                          'Obs: ${classItem.observation}',
                                          style: TextStyle(
                                            color: Colors.white.withOpacity(0.7),
                                          ),
                                        ),
                                        ...
                                        onPressed: () async {
                                          final confirm = await showDialog<bool>(
                                            ...
                                            builder: (context) => AlertDialog(
                                              ...
                                              content: Text(
                                                'Deseja realmente excluir a aula ${classItem.name}?',
                                                style: const TextStyle(color: Colors.white),
                                              ),
                                              actions: [
                                                TextButton(
